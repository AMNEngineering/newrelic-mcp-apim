...
- **Preflight inputs** — fill `newrelic_mcp_app_id` in the env `*.tfvars`, confirm
  the Key Vault secret name, and grant APIM's managed identity KV `get` on
  `co-wus2-newrelic-kv-p01`. See ../DECISIONS.md.
