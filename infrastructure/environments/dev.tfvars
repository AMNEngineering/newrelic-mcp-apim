...
# Entra app (DECISION #2: reuse Bart's api://newrelic-mcp-reader). Callers present
# a JWT for this audience carrying the MCP.Read app role.
# TODO(Preflight): fill the real app object/client id from Entra (the prototype
# repo referenced api://newrelic-mcp-reader but did not commit the GUID).
